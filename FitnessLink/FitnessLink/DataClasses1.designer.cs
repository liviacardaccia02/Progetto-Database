...
namespace FitnessLink
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="SocialNetworkPalestra")]
    ...
    partial void DeleteUTENTE(UTENTE instance);
		...
		public DataClasses1DataContext() : 
				base(global::FitnessLink.Properties.Settings.Default.SocialNetworkPalestraConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCodiceAllenamentoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GruppoMuscolareEsercizio", DbType="VarChar(20) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
    ...
    partial void OnDurataMinutiChanging(int value);
    ...
    partial void OnUtenteChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DurataMinuti", DbType="Int NOT NULL")]
    ...
    partial void OnCreatoreChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GruppoMuscolare", DbType="VarChar(20) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
    ...
    partial void OnUtenteChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="INTERAZIONE_POST", Storage="_POST", ThisKey="IDinterazione", OtherKey="Interazione")]
		public EntitySet<POST> POST
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.INTERAZIONE1 = this;
		}
		
		private void detach_POST(POST entity)
		{
			this.SendPropertyChanging();
			entity.INTERAZIONE1 = null;
		}
	}
	...
	public partial class POST : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Interazione;
		...
		private EntityRef<INTERAZIONE> _INTERAZIONE1;
    ...
    partial void OnInterazioneChanging(System.Nullable<int> value);
    partial void OnInterazioneChanged();
    ...
    partial void OnAutoreChanged();
		...
		{
			this._ALLENAMENTO = default(EntityRef<ALLENAMENTO>);
			this._INTERAZIONE1 = default(EntityRef<INTERAZIONE>);
			this._UTENTE = default(EntityRef<UTENTE>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Interazione", DbType="Int")]
		public System.Nullable<int> Interazione
		{
			get
			{
			...
			set
			{
				if ((this._Interazione != value))
				{
					if (this._INTERAZIONE1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnInterazioneChanging(value);
					this.SendPropertyChanging();
					this._Interazione = value;
					this.SendPropertyChanged("Interazione");
					this.OnInterazioneChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="INTERAZIONE_POST", Storage="_INTERAZIONE1", ThisKey="Interazione", OtherKey="IDinterazione", IsForeignKey=true)]
		public INTERAZIONE INTERAZIONE1
		{
			get
			{
				return this._INTERAZIONE1.Entity;
			}
			set
			{
				INTERAZIONE previousValue = this._INTERAZIONE1.Entity;
				if (((previousValue != value) 
							|| (this._INTERAZIONE1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._INTERAZIONE1.Entity = null;
						previousValue.POST.Remove(this);
					}
					this._INTERAZIONE1.Entity = value;
					if ((value != null))
					{
						value.POST.Add(this);
						this._Interazione = value.IDinterazione;
					}
					else
					{
						this._Interazione = default(Nullable<int>);
					}
					this.SendPropertyChanged("INTERAZIONE1");
				}
			}
		}
